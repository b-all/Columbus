// define StillGraphCreator object
var isHovering = false;
var StillGraphCreator = function(svg, nodes, edges){
    ...
    StillGraphCreator.prototype.consts = {
    ...
    StillGraphCreator.prototype.dragmove = function(d) {
        var thisGraph = this;
    ...
    // keydown on main svg
    StillGraphCreator.prototype.svgKeyDown = function() {
        var thisGraph = this,
    ...
    StillGraphCreator.prototype.deleteNode = function () {
        var selectedNode = state.selectedNode;
    ...
    StillGraphCreator.prototype.removeNodeAndNeighbors = function () {
        var selectedNode = state.selectedNode;
        thisGraph.nodes.splice(thisGraph.nodes.indexOf(selectedNode), 1);
    ...
    StillGraphCreator.prototype.spliceLinksAndTheirNodesForNode = function (node) {
        var thisGraph = this,
    ...
    StillGraphCreator.prototype.deleteRel = function () {
    ...
    StillGraphCreator.prototype.svgKeyUp = function() {
    ...
    StillGraphCreator.prototype.updateGraph = function () {
    ...
    StillGraphCreator.prototype.spliceLinksForNode = function(node) {
        var thisGraph = this,
    ...
    StillGraphCreator.prototype.addNode = function (node) {
        thisGraph.nodes.push(node);
    };

    StillGraphCreator.prototype.addRel = function (rel) {
        thisGraph.edges.push(rel);
    };

    StillGraphCreator.prototype.hasNode = function(id) {
    ...
    StillGraphCreator.prototype.getNodeIndexById = function(id) {
        for (var i = 0; i < thisGraph.nodes.length; i++) {
            if (nodes[i].id === id) {
                return i;
            }
    ...
    StillGraphCreator.prototype.filter = function (term) {
        var count = 0;
        var filteredIds = [];
    ...
    StillGraphCreator.prototype.unfilter = function () {
    ...
    StillGraphCreator.prototype.getSelectedNodeId = function () {
        var thisGraph = this;
        return thisGraph.state.selectedNode;
    };

    StillGraphCreator.prototype.addNodeNeighbors = function (data, xLoc, yLoc, width, height) {
